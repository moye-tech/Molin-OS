...
DEFAULT_SOURCES = ["xiaohongshu"]  # 逐步扩展
...
def get_adapter(source_name: str):
    ...
    adapters = {
        ...
        # "douyin": {"module": "adapters.douyin.adapter", "class_name": "DouYinAdapter"},
    }
...
def main():
    ...
    for source_name in sources:
        ...
        try:
            ...
            from adapters.xiaohongshu.adapter import CollectionContext, asdict
