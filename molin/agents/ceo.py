...
class CEOAgent:
    ...
    Q2_OKR = {
        "O1": "建立稳定的被动收入流 (目标: ¥5,000/月)",
        "KR1.1": "闲鱼店铺上线，月销售额¥2,000",
        "KR1.2": "小红书粉丝500+，开通蒲公英变现",
        "KR1.3": "完成3个freelance项目，入账¥3,000",
        "O2": "构建可复制的AI内容生产线",
        "KR2.1": "内容工厂日产10篇，自动化率80%",
        "KR2.2": "打通小红书+闲鱼+知乎发布管线",
        "KR2.3": "建立视频内容生成能力 (无GPU版)",
    }
